  ...
  const projects = [
    {
      ...
      priceFrom: 2850,
      currency: 'UF',
      shortDescription: 'Departamentos de inversión en pleno corazón de Independencia, con excelente conectividad y alta plusvalía proyectada.',
...
La ubicación privilegiada permite acceso inmediato al metro, hospitales, centros comerciales y las principales vías de Santiago. Ideal para profesionales jóvenes y estudiantes universitarios como mercado objetivo de arriendo.`,
      ...
      metaDescription: 'Invierte en Parque Independencia, Independencia. Departamentos desde 2.850 UF con alta plusvalía y excelente rentabilidad.',
      ...
      amenities: ['Piscina', 'Quincho', 'Gimnasio', 'Sala de cowork', 'Lounge', 'Bicycle parking', 'Conserjería 24/7'],
      financing: [
        { name: 'Crédito Hipotecario', description: 'Financiamiento bancario con hasta 90% de financiamiento' },
        { name: 'Pie en cuotas', description: 'Divide el pie en cuotas mensuales durante la construcción' },
        { name: 'Apoyo al pie', description: 'Bono de contribución al pie de entrada' },
      ],
      images: [
        { url: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=1200&q=80', isMain: true, sortOrder: 1, alt: 'Fachada Parque Independencia' },
        { url: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=1200&q=80', isMain: false, sortOrder: 2, alt: 'Lobby del edificio' },
        { url: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=1200&q=80', isMain: false, sortOrder: 3, alt: 'Departamento tipo' },
        { url: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=1200&q=80', isMain: false, sortOrder: 4, alt: 'Área de amenities' },
      ],
    },
    {
      name: 'Ñuñoa Central',
      ...
      priceFrom: 3200,
      currency: 'UF',
      shortDescription: 'Inversión en la tradicional comuna de Ñuñoa, barrio consolidado con alta demanda de arriendo y proyección de plusvalía sostenida.',
...
Proyección de rentabilidad estimada: entre 4.5% y 5.5% anual neto, con plusvalía proyectada superior al 20% en 5 años.`,
      ...
      metaDescription: 'Invierte en Ñuñoa Central. Departamentos desde 3.200 UF en la comuna más demandada de Santiago con alta rentabilidad.',
      ...
      typologies: [
        ...
        { name: '3D / 2B', usefulArea: 78.5, totalArea: 84.0, priceFrom: 6500, observations: 'Con bodega incluida', sortOrder: 4 },
      ],
      amenities: ['Terraza sky', 'Sala de reuniones', 'Gimnasio', 'Sala de juegos', 'Piscina temperada', 'Portería 24/7'],
      financing: [
        { name: 'Crédito Hipotecario', description: 'Financiamiento con los principales bancos del sistema' },
        { name: 'Pie en cuotas', description: 'Divide el pie en 36 cuotas sin interés' },
        { name: 'Inversión con renta garantizada', description: '6 meses de renta garantizada post entrega' },
      ],
      images: [
        { url: 'https://images.unsplash.com/photo-1583608205776-bfd35f0d9f83?w=1200&q=80', isMain: true, sortOrder: 1, alt: 'Fachada Ñuñoa Central' },
        { url: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=1200&q=80', isMain: false, sortOrder: 2, alt: 'Living departamento' },
        { url: 'https://images.unsplash.com/photo-1556912173-46c336c7fd55?w=1200&q=80', isMain: false, sortOrder: 3, alt: 'Cocina equipada' },
        { url: 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=1200&q=80', isMain: false, sortOrder: 4, alt: 'Piscina sky' },
      ],
    },
    {
      ...
      priceFrom: 7500,
      currency: 'UF',
      shortDescription: 'Departamentos de lujo en Vitacura con vistas al parque, para inversores de alto patrimonio que buscan activos premium.',
...
Entrega inmediata. Unidades limitadas disponibles.`,
      ...
      metaDescription: 'Departamentos de lujo en Vitacura con entrega inmediata. Frente al parque Bicentenario. Inversión premium desde 7.500 UF.',
      ...
      typologies: [
        ...
        { name: '3D / 3B Penthouse', usefulArea: 145.0, totalArea: 165.0, priceFrom: 14500, observations: 'Terraza privada 45m²', sortOrder: 3 },
      ],
      amenities: ['Sala de eventos', 'Business center', 'Spa', 'Piscina climatizada', 'Sauna', 'Conserje premium 24/7', 'Estacionamiento visitantes', 'Bodega'],
      financing: [
        { name: 'Crédito Hipotecario Premium', description: 'Condiciones preferenciales con bancos seleccionados' },
        { name: 'Entrega inmediata', description: 'Escrituración y entrega en 30 días' },
      ],
      images: [
        { url: 'https://images.unsplash.com/photo-1567496898669-ee935f5f647a?w=1200&q=80', isMain: true, sortOrder: 1, alt: 'Vitacura Park View fachada' },
        { url: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1200&q=80', isMain: false, sortOrder: 2, alt: 'Interior premium' },
        { url: 'https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=1200&q=80', isMain: false, sortOrder: 3, alt: 'Terraza con vista' },
        { url: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200&q=80', isMain: false, sortOrder: 4, alt: 'Área social' },
      ],
    },
    {
      ...
      priceFrom: 2100,
      currency: 'UF',
      shortDescription: 'Oportunidad de inversión accesible en San Miguel, con excelente conectividad y alta demanda de arriendo estudiantil y laboral.',
...
Rentabilidad estimada: 5% a 6.5% anual neta. Ideal para primer departamento de inversión.`,
      ...
      metaDescription: 'Primer departamento de inversión desde 2.100 UF en San Miguel. Alta rentabilidad y excelente conectividad.',
      ...
      financing: [
        { name: 'Crédito Hipotecario', description: 'Acceso a financiamiento bancario tradicional' },
        { name: 'Pie en cuotas', description: 'Pie dividido en 24 cuotas' },
        { name: 'Subsidio habitacional', description: 'Compatible con subsidios DS19' },
      ],
      images: [
        { url: 'https://images.unsplash.com/photo-1560185127-6ed189bf02f4?w=1200&q=80', isMain: true, sortOrder: 1, alt: 'San Miguel Connect fachada' },
        { url: 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=1200&q=80', isMain: false, sortOrder: 2, alt: 'Interior departamento' },
        { url: 'https://images.unsplash.com/photo-1484154218962-a197022b5858?w=1200&q=80', isMain: false, sortOrder: 3, alt: 'Cocina eficiente' },
      ],
    },
    {
      ...
      priceFrom: 4800,
      currency: 'UF',
      shortDescription: 'Próximo lanzamiento en Las Condes. Regístrate para recibir información exclusiva antes del lanzamiento oficial.',
...
Información completa disponible próximamente. Los inversores registrados tendrán acceso prioritario.`,
      ...
      metaDescription: 'Próximo proyecto en Las Condes. Regístrate para información exclusiva.',
      ...
      financing: [
        { name: 'Crédito Hipotecario', description: 'Financiamiento bancario' },
        { name: 'Pie en cuotas', description: 'Pie en cuotas durante construcción' },
      ],
      images: [
        { url: 'https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=1200&q=80', isMain: true, sortOrder: 1, alt: 'Las Condes alto' },
      ],
    },
  ]
  ...
  // ─── Sample Leads ─────────────────────────────────────
  const firstProject = await prisma.project.findFirst({ where: { slug: 'parque-independencia' } })
