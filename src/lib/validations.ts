...
export const projectSchema = z.object({
  ...
  linkDrive:    z.string().url('URL inválida').optional().nullable().or(z.literal('')),
  linkStock:    z.string().url('URL inválida').optional().nullable().or(z.literal('')),
  brochureUrl:  z.string().optional().nullable(),
  brochurePubId:z.string().optional().nullable(),
